                ...
                {tabs.map((tab) => (
                    <button
                        ...
                        className={`px-1 pb-2 relative transition-colors
                            ${page === tab.id ? "text-green-500" : "text-gray-400 hover:text-gray-200"}
                        `}
                    >
                        {tab.label}
                        ...
                        {page === tab.id && (
                            <motion.div
                                layoutId="underline"
                                className="absolute left-0 right-0 -bottom-[2px] h-[3px] bg-green-500 rounded-full"
                    ...
                    >
                        {tabs.map((tab) => (
                            <button
                                ...
                                className={`${page === tab.id ? "text-green-500" : "text-white"}`}
                            >
                                {tab.label}
                            </button>
                        ))}
